...
train = repeat(append!(repeat([0.01],19),[0.015,0.05,0.1,0.3,1.0,3.0,30.0]),60)
...
function f2(data)
        save(string("deterministic_short_",Base.parse(Int, ENV["SLURM_ARRAY_TASK_ID"]),".jld"), "data", data)
end
